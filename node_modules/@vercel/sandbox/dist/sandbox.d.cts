...
import { ManagedImage, RUNTIMES } from "./constants.cjs";
 ...
 */
type SandboxImage = `vercel/sandbox/${ManagedImage}` | (string & {});
/**
 ...
 * @inline
 */
type ForkSandboxParams = Omit<BaseCreateSandboxParams, "source"> & {
  /**
