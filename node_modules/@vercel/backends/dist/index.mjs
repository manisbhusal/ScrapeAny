...
async function downloadInstallAndBundle(args) {
	...
	const { cliType, lockfilePath, lockfileVersion, packageJsonPackageManager, packageJsonDevEngines, turboSupportsCorepackHome } = await scanParentDirs(entrypointFsDirname, true, repoRootPath);
