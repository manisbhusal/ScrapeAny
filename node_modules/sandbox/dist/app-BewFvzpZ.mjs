...
const create = import_cjs$16.command({
	...
	async handler({ name, nonPersistent, ports, scope: scope$1, runtime: runtime$1, image, timeout: timeout$1, vcpus: vcpus$1, silent, snapshot: snapshot$1, connect: connect$1, envVars, tags, snapshotExpiration: snapshotExpiration$1, keepLastSnapshots: keepLastSnapshots$1, keepLastSnapshotsFor: keepLastSnapshotsFor$1, deleteEvictedSnapshots: deleteEvictedSnapshots$1, networkPolicy: networkPolicyMode$1, allowedDomains: allowedDomains$1, allowedCIDRs: allowedCIDRs$1, deniedCIDRs: deniedCIDRs$1 }) {
		if (runtime$1 !== void 0 && image !== void 0) throw new Error("--runtime and --image cannot be used together.");
		...
		const sandbox = snapshot$1 ? await sandboxClient.create({
			...
			token: scope$1.token,
			ports,
			...image !== void 0 ? { image } : runtime$1 !== void 0 ? { runtime: runtime$1 } : {},
			timeout: (0, import_ms$3.default)(timeout$1),
			resources,
			networkPolicy: networkPolicy$1,
			env: envVars,
...
const args$2 = {
	...
	timeout: import_cjs$14.option({
		...
		description: "Override the maximum sandbox duration (inherited from source if omitted). Example: 5m, 30m"
	}),
	vcpus,
	ports: publishPorts,
	...
	envVars: import_cjs$14.multioption({
		...
		short: "e",
		type: ObjectFromKeyValue,
		description: "Environment variables to set on the fork. When provided, fully replaces the env vars copied from the source (no per-key merge)."
	}),
...
const fork = import_cjs$14.command({
	name: "fork",
	description: "Fork an existing sandbox into a new one. Copies config (cpu, timeout, network policy, tags, env vars, etc.) from the source sandbox; any flag passed here overrides the copied value.",
	args: args$2,
	examples: [{
...
const run = import_cjs$13.command({
	...
	async handler({ removeAfterUse, stopAfterUse, ...rest$1 }) {
		...
		if (rest$1.runtime !== void 0 && rest$1.image !== void 0) throw new Error("--runtime and --image cannot be used together.");
		let sandbox;
		if (rest$1.name) try {
...
const list = import_cjs$12.command({
	...
	async handler({ scope: { token: token$1, team: team$1, project: project$1 }, all, namePrefix, sortBy, sortOrder, tags, limit, cursor }) {
		...
		const columns = {
			...
			"IMAGE/RUNTIME": { value: (s$1) => s$1.image ? formatImage(s$1.image) : s$1.runtime ?? "-" },
			TIMEOUT: { value: (s$1) => {
...
const app = (opts) => {
	...
	return (0, import_cjs.subcommands)({
		name: appName,
...
//# sourceMappingURL=app-BewFvzpZ.mjs.map